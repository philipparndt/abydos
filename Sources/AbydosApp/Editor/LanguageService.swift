...
final class LanguageService {
	...
	struct ServerNotice: Equatable {
		...
		/// What the button that opens `manual` says. "How to install" is right
		/// for the notice this strip was built for and wrong for a server that
		/// is installed, started, and complaining.
