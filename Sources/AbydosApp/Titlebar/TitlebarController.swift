...
final class TitlebarController: NSObject, NSToolbarDelegate {
	...
	static let capsuleItem = NSToolbarItem.Identifier("abydos.capsule")

	static let subprojectItem = NSToolbarItem.Identifier("abydos.subproject")

	private static let worktreeItem = NSToolbarItem.Identifier("abydos.worktree")

	static let devContainerItem = NSToolbarItem.Identifier("abydos.devcontainer")

	static let runItem = NSToolbarItem.Identifier("abydos.run")
	...
	var worktreePill: WorktreePillButton!

	var devContainerPill: DevContainerPillButton!
	...
	var pilledContainer: DevContainerFile.Choice?
