...
public enum JavaTooling {
	...
	/// `IDEAI_JAVA_DEBUG_PLUGIN` overrides the lot.
	public static func debugPlugin() -> String? {
		if let override = ProcessInfo.processInfo.environment["IDEAI_JAVA_DEBUG_PLUGIN"],
	...
	set IDEAI_JAVA_DEBUG_PLUGIN to the jar.
