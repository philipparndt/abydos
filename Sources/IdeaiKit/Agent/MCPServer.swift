...
public final class MCPServer {
	...
	public func configurationJSON(serverName: String = "ideai") -> String {
	...
	public func qualifiedToolNames(serverName: String = "ideai") -> [String] {
	...
	private func serve(_ request: HTTPRequest, on connection: NWConnection) {
		...
		case "initialize":
			...
			respond(result: [
				...
				"serverInfo": ["name": "ideai", "version": "0.1.0"],
			], id: id, on: connection)
