<!-- What this item changes about `screenshots`. Folded into
     ...
     Nothing has been said about screenshots yet, so this is all ADDED.
-->

## ADDED Requirement: A capture is a picture of the app, not of the machine it was taken on
