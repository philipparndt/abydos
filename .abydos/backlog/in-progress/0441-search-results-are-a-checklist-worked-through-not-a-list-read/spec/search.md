## ADDED Requirement: Search results can be marked done, several at a time
...
## ADDED Requirement: Marking done is never a deletion, and never wears ⌫
...
## ADDED Requirement: A mark survives the search being run again
...
## ADDED Requirement: Marks are hidden on request, so the list can also empty
...
## ADDED Requirement: ⌘Z in the results list takes back the last marking
...
## ADDED Requirement: The results list can be worked from the keyboard
