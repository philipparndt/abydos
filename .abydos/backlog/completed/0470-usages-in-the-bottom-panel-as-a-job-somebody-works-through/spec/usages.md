<!-- What this item changes about `usages`. Folded into
     ...
     Nothing has been said about usages yet, so this is all ADDED.
-->

## ADDED Requirement: Usages arrive in the bottom panel, beside search
...
## ADDED Requirement: A usages list is the same checklist search is
...
## ADDED Requirement: ↓ through a usages list shows each one and keeps the keyboard
...
## ADDED Requirement: A usages list can be expanded into a window, and that is remembered
