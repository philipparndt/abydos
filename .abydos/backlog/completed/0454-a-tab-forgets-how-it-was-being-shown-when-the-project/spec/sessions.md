<!-- What this item changes about `sessions`. Folded into
     ...
     Nothing has been said about sessions yet, so this is all ADDED.
-->

## ADDED Requirement: A tab comes back in the mode it was being shown in
...
## ADDED Requirement: A split comes back with its divider where it was left
...
## ADDED Requirement: A session that says nothing about a mode gets the file kind's default
...
## ADDED Requirement: A mode is ignored for a file that cannot be shown in it
