...
struct BundledChartTests {
	@Test func theShippedChartMatchesTheSource() throws {
		let repository = URL(fileURLWithPath: #filePath)
			...
			.deletingLastPathComponent()
			.deletingLastPathComponent()
		let source = repository.appendingPathComponent("DevPod/chart/abydos-devpod")
		let shipped = repository.appendingPathComponent("Sources/AbydosApp/Resources/devpod-chart")
