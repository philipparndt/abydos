...
*Ruled out: opening a marked link on a bare click now that it is underlined.*
The underline changes what the pointer says, not what the click does; a bare
click inside tmux with the mouse on is the program's, and the selection rule
of 2026-09-10 stands.
...
| `0:1:bare` — a bare click on the marked link | `opened=0`, and the click went to the program, which was tracking the mouse |
...
> a plain web address a program printed still shows itself under ⌘, and ⌘-click
> opens either.
