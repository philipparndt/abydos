...
Replacing what find found: the find bar's replace half, the ⌘R that opens it,
replacing one match or all of them as a single edit, and what a replacement
means with regular expressions on and off.
