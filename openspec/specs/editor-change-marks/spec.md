...
Per-line git change indication in the editor gutter: what is marked, against what the difference is taken, how marks survive typing, and when they are recomputed.
## Requirements
