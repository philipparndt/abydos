...
Where the ways of starting a debug session are offered: the run control's
ladybird and its menu, and the Run menu. A pane that shows a session does not
ask how to start one.
