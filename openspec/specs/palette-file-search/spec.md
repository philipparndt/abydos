...
Opening a file by typing part of its path into the command palette: where the candidates come from, how they are ranked, when the index is built, and what the palette says while it is not ready.
