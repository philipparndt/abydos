...
Usages SHALL arrive in the bottom panel, beside search.
...
A usages list SHALL be the same checklist search is.
...
↓ through a usages list SHALL show each one, and SHALL keep the keyboard.
...
A usages list SHALL be able to be expanded into a window, and that SHALL be remembered.
...
The keyboard SHALL stay in the list in every home, including beside a terminal.
