...
An archive in the project tree — a zip, a tar, a gzipped tar, a lone gzip — can be opened like a folder to show what is in it without unpacking it: entries listed from the archive itself, opened read only, one extracted beside the archive when asked, and the shown archives remembered with the tree.
## Requirements
